...
void func_800CD8E8(s32 arg0, s32 arg1, s_800E330C* arg2) // 0x800CD8E8
{
    ...
    {
        switch ((u32)g_SysWork.gameStateCounter % 8)
        {
            case 0:
            case 1:
                switch (arg0 & 3)
...
void Particle_BeamDraw(const VECTOR3* from, const VECTOR3* to)
{
    ...
    switch (g_MapOverlayHdr.field_16)
    {
        ...
        case 2:
            ...
            else if (g_SysWork.field_2388.isFlashlightOn)
            {
                prim->r0 = 0xFF;
                prim->g0 = 0xFF;
                prim->b0 = 0xFF;
            }
            else if (g_SysWork.field_2388.field_1C[0].effectsInfo.field_0.field_00[0] & 1)
            {
                prim->r0 = 0x30;
                prim->g0 = 0x30;
                prim->b0 = 0x30;
            }
            else if (!(g_SysWork.field_2388.field_1C[1].effectsInfo.field_0.field_00[0] & (1 << 0)))
            {
                prim->r0 = 0xFF;
                prim->g0 = 0xFF;
                prim->b0 = 0xFF;
