...
void Game_NpcUpdate(void) // 0x80038354
{
         ...
         k++, curNpc++)
    {
        ...
        if (curNpc->model.charaId <= CHARA_LAST_ENEMY_ID)
        {
            ...
            // Set NPC visibility.
            if ((g_SysWork.field_2388.field_154.effectsInfo.field_0.field_00[0] & 0x2 && curDistToNpc > SQUARE(15)) ||
                (!(g_SysWork.field_2388.field_154.effectsInfo.field_0.field_00[0] & 0x2) &&
