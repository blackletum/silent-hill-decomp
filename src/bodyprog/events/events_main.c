...
void Event_Update(bool disableButtonEvents) // 0x800373CC
{
    ...
    while (true)
    {
        ...
        if (mapEvent->activationType == TriggerActivationType_Button)
        {
            if ((g_SysWork.field_2388.field_154.effectsInfo.field_0.field_00[0] & 2) && !g_SysWork.field_2388.isFlashlightOn &&
                ((g_SysWork.field_2388.field_1C[0].effectsInfo.field_0.field_00[0] & 1) || (g_SysWork.field_2388.field_1C[1].effectsInfo.field_0.field_00[0] & 1)))
            {
